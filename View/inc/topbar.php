	...
	<nav class="light-blue">
		<div class="container">
			<div class="nav-wrapper">
				...
				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo">O'FUTBOL</a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<li class="<?php echo ($_GET['a']=="chapters")?"active" : ""; ?>"><a href="<?=ROOT_URL?>blog_chapters.html">Les équipes</a></li>
